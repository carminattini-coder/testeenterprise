...
EMPRESAS = [
    ...
    },
    {
        ...
        "carteiras": "Click to Pay (confirmado); sem Apple Pay/Google Pay",
    ...
    },
    {
        ...
        "carteiras": "Google Pay (confirmado); PIX via Mercado Pago",
    ...
    },
    {
        ...
        "metodos": "Cartão crédito/débito, PIX, Boleto, Parcelamento",
        "carteiras": "Não aceita (apenas crédito e PIX confirmados)",
    ...
    # BELEZA E COSMÉTICOS
    {
        ...
        "metodos": "Cartão crédito/débito, PIX, Boleto, Parcelamento",
        "carteiras": "Não aceita (PIX e crédito apenas — sem Apple Pay/Google Pay)",
    ...
    },
    {
        ...
        "metodos": "Cartão crédito/débito, PIX, Boleto, Parcelamento",
        "carteiras": "Natura Pay (conta digital própria para consultores); sem Apple Pay/Google Pay no site",
        "gateway": "A verificar",
        "checkout": "Transparente",
        "score": 18,
        "prioridade": "Alta",
    ...
    },
    {
        ...
        "carteiras": "PayPal (confirmado); Mercado Pago (confirmado); sem Apple Pay/Google Pay no BR",
    ...
    # FARMÁCIAS E SAÚDE
    {
        ...
        "metodos": "Cartão crédito/débito, PIX, Boleto, Parcelamento",
        "carteiras": "Não confirmado (crédito e PIX apenas; PagStix loyalty program)",
    ...
    },
    {
        ...
        "volume": "R$ 500 M–1 bi /ano estimado",
        "metodos": "Cartão crédito/débito, PIX, Boleto, Parcelamento",
        "carteiras": "Não aceita (crédito Visa/Master/Amex/Elo/JCB, PIX e boleto apenas)",
        "gateway": "A verificar",
        "checkout": "A verificar",
        "score": 14,
        "prioridade": "Media-Alta",
    ...
    },
    {
        ...
        "metodos": "Cartão crédito/débito, PIX, Boleto",
        "carteiras": "Apple Pay; Samsung Pay (loja física confirmado — e-commerce a confirmar)",
        "gateway": "A verificar",
        "checkout": "A verificar",
        "score": 13,
        "prioridade": "Media-Alta",
    ...
    },
    {
        ...
        "volume": "R$ 2,0 bi+ /ano digital estimado",
        "metodos": "Cartão crédito/débito, PIX, Boleto, Parcelamento",
        "carteiras": "Leroy Merlin Pay (fintech própria com cartão Elo); sem Apple Pay/Google Pay",
    ...
    # PET PREMIUM
    {
        ...
        "metodos": "Cartão crédito/débito, PIX, Boleto, Parcelamento",
        "carteiras": "Nupay (Nubank — confirmado); sem Apple Pay/Google Pay",
        "gateway": "A verificar",
        "checkout": "Transparente",
        "score": 16,
        "prioridade": "Alta",
    ...
    },
    {
        ...
        "metodos": "Cartão crédito/débito, PIX, Boleto, Parcelamento",
        "carteiras": "Apple Pay; Google Pay (confirmado no site global — verificar .com.br)",
    ...
    },
    {
        ...
        "metodos": "Cartão crédito/débito, PIX, Boleto",
        "carteiras": "Apple Pay; Google Pay (site global levi.com confirma — verificar .com.br)",
        "gateway": "A verificar",
        "checkout": "A verificar",
        "score": 14,
        "prioridade": "Media-Alta",
    ...
    },
    {
        ...
        "volume": "R$ 500 M–1 bi /ano estimado",
        "metodos": "Cartão crédito/débito, PIX, Boleto, Parcelamento",
        "carteiras": "Não aceita (crédito, boleto e PIX apenas — sem carteiras digitais)",
        "gateway": "A verificar",
        "checkout": "Transparente",
        "score": 15,
        "prioridade": "Media-Alta",
    ...
    },
    {
        ...
        "carteiras": "Google Pay; Samsung Pay (via Cartão Carrefour Mastercard); Click to Pay",
        "gateway": "A verificar (múltiplos)",
        "checkout": "Transparente",
        "score": 17,
        "prioridade": "Alta",
    ...
    },
    {
        ...
        "volume": "R$ 500 M–1 bi /ano digital estimado",
        "metodos": "Cartão crédito/débito, PIX, Boleto, Parcelamento",
        "carteiras": "Não confirmado (sem dados públicos de carteiras digitais)",
        "gateway": "A verificar",
        "checkout": "A verificar",
        "score": 13,
        "prioridade": "Media-Alta",
